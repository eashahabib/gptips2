...
gp.runcontrol.timeout = 1*60*60;            %seconds
...
x = meshgridequal(-1:0.4:0.6, 4);
x1 = x(:,1); x2 = x(:,2); x3 = x(:,3); x4 = x(:,4);
y = 4.*x1.*x2.*log(abs(x3)) + exp(sin(x4));
...
gp.operators.mutation.p_mutate = 0.10;
gp.operators.crossover.p_cross = 0.90;
gp.operators.directrepro.p_direct = 0.00;
